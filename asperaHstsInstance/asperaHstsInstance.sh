...
echo "Para deletar:" 
echo "1. oc delete -f /tmp/$PROJECT/asperaHstsInstance/asperaHstsInstance_OK.yaml"
echo "2. oc delete secret asperanoded-creds"
echo "3. oc delete -f /tmp/$PROJECT/asperaHstsInstance/asperaHstsInstancePvc_OK.yaml"
