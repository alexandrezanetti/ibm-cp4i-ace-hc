...
public class GetTimeout2_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
	        ...
	        final String tranid = null;			
		    	...
		    	if (falhouCache == true) {
		    		criarResposta(outMessage, "cache2:NOK");
		    	}else{
		    		criarResposta(outMessage, "cache2:OK:" + resultadoFinal);
		    	}
	...
	private String buscarDadosCache(MbMessageAssembly inAssembly, MbOutputTerminal alt, final String tranid) throws Exception {
			String retorno = null;
			String chaveCacheHealthCheck = "chaveCacheHealthCheck2"; //possui dados

	    	boolean falhouCache = false;
			try {
				MbGlobalMap mapa9310_Map = MbGlobalMap.getGlobalMap("MAPA_9310");
				//mapa9310_Map.put("chaveCacheHealthCheck", "valorteste");
				retorno = (String)mapa9310_Map.put(chaveCacheHealthCheck, chaveCacheHealthCheck);
